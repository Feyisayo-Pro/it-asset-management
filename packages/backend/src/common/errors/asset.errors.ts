...
export class InvalidAssetTagFormatError extends ApplicationError {
  readonly code = 'INVALID_ASSET_TAG_FORMAT';
  constructor(tag: string) {
    super('Asset tag must match the format AST-{YYYY}-{SEQ}', { assetTag: tag });
  }
}
